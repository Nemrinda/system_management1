        ...
        <div id="layoutSidenav_content">
            <div class="container-fluid px-4">
                <div class="d-flex justify-content-between align-items-center mt-4 mb-4">
                    <div>
                        <h1 class="text-dark fw-bold border-start btn-outline-danger border-5 ps-3">Add New Course</h1>
                ...
                <div class="card-body">
                    <form method="POST" action="./createAction.php" class="border p-3 rounded-3 border-primary" enctype="multipart/form-data">
                        <div class=" row">
                            <div class="col ">
                                <div class="mb-3 col-md-12">
                                    <label for="title" class="form-label">course_name</label>
                                    <input type="text" name="course_name" class="form-control" id="course_name" placeholder="Input course_name">
                                </div>

                                <div class="mb-3 col-md-12">
                                    <label for="title" class="form-label">course_price</label>
                                    <input type="text" name="course_price" class="form-control" id="course_price" placeholder="Input course_price">
                                </div>
                                <div class="mb-3 col-md-12">
                                ...
                                <div class="mb-3 col-md-6">
                                    <button name="btn_save" type="submit" class="btn btn-primary mb-3 mt-3">Create New</button>
                                </div>
                            </div>
                            <div class="col mt-4">
                                <!--img pre -->
                                <div class="col-12 d-flex align-items-center justify-content-center">
                                    <img class="border border-secondary" id="imagePreview" style="width: 300px; height: 300px; object-fit: cover;" src="" alt="">
                                </div>
                            </div>
                        </div>
                    </form>
